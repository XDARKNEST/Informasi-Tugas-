...
setInterval(() => {
  ...
  cd.innerHTML =
    d1 <= 0
      ...
      : `⏳ Deadline: ${Math.floor(d1 / 86400000)} hari ${Math.floor(
          d1 / 3600000
        ) % 24} jam ${Math.floor(d1 / 60000) % 60} menit ${
          Math.floor(d1 / 1000) % 60
        } detik`;
  ...
  nextCd.innerHTML =
    d2 <= 0
      ...
      : `📅 Tugas Selanjutnya: ${Math.floor(d2 / 86400000)} hari ${Math.floor(
          d2 / 3600000
        ) % 24} jam ${Math.floor(d2 / 60000) % 60} menit ${
          Math.floor(d2 / 1000) % 60
        } detik`;
}, 1000);
